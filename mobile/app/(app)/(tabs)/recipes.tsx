        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.recipeCard}>
            ...
            <View style={styles.recipeContent}>
              ...
              <View style={styles.recipeStats}>
                ...
                {item.rendimento_porcoes && (
                  <View style={styles.statItem}>
                    ...
                    />
                    <Text style={styles.statText}>
                      {item.rendimento_porcoes} porções
                    </Text>
                  </View>
                )}

                {item.vezes_executada && item.vezes_executada > 0 && (
                  <View style={styles.statItem}>
                    <MaterialCommunityIcons
              ...
              {item.tags_dieta && item.tags_dieta.length > 0 && (
                <View style={styles.tagsContainer}>
                  {item.tags_dieta.slice(0, 2).map((tag, idx) => (
                    <View key={idx} style={styles.tag}>
                      <Text style={styles.tagText}>{tag}</Text>
                    </View>
                  ))}
                  {item.tags_dieta.length > 2 && (
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <MaterialCommunityIcons
              ...
              color="#ddd"
            />
            <Text style={styles.emptyText}>Nenhuma receita disponível</Text>
