...
**No CookMe:** o `cookme-ai-service` (próximo passo) será um agente LangChain em Python rodando no Lambda. Ver seção [Projeto Âncora](#projeto-ancora-cookme-ai-service).
