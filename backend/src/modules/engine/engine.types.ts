...
export interface ItemCanonizado {
   ...
   * núcleo+especificador. Permite ao cliente agrupar por categoria mesmo
   * quando a variedade exata (o especificador) não bate entre lojas/receitas
   * — ex: uma receita que pede "queijo" aceita qualquer provolone/mussarela.
   * null quando o item não veio dessa camada (ex: resolvido por EAN direto).
   */
  nucleo: string | null;
