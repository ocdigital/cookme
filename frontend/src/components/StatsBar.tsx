    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-3 shadow-sm">
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
        {items.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-2 pb-3 sm:pb-0 sm:pr-5 border-b sm:border-b-0 sm:border-r border-gray-100 dark:border-gray-700 last:border-b-0 sm:last:border-r-0"
          >
